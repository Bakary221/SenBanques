...
CMD mkdir -p storage/oauth && php artisan passport:install --force && php artisan passport:keys --force && php artisan migrate:fresh --force && php artisan db:seed --force && apache2-foreground
